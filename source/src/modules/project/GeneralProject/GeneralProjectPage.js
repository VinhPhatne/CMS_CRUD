...
const messages = defineMessages({
    ...
    createNew: {
        id: 'generalProjectPage.createNew',
        defaultMessage: '+',
    },
    deleteSuccess: {
        id: 'generalProjectPage.deleteSuccess',
        defaultMessage: 'Xoá slider thành công',
    },
    slider: {
        id: 'generalProjectPage.slider',
        defaultMessage: 'Slider',
    },
    revenue: {
        id: 'generalProjectPage.revenue',
        defaultMessage: 'Lợi nhuận chia sẻ',
    },
    setting: {
        id: 'generalProjectPage.setting',
        defaultMessage: 'setting',
    },
    updateSuccess: {
        id: 'generalProjectPage.updateSuccess',
        defaultMessage: 'Cập nhật {objectName} thành công',
    },
});

const GeneralProjectPage = ({ groupName }) => {
